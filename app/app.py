...
# make key assumptions / cash conversion cycle cells a darker color with white letters
...
def highlight_cells(df):
    ...
    # highlight the section headers with light gray, black text, and underline
    header_rows = [2, 7, 13, 27]
    for row in header_rows:
        for col in df.columns:
            highlighted.loc[row, col] = 'background-color: #666666; color: black; border-bottom: 2px solid black'
    
    # highlight forecast cells with transparent yellow
